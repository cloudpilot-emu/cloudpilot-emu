...
namespace {
    const uint32_t sig_adc_udivmod_first[] = {
    ...
    const uint32_t sig_adc_udivmod_second[] = {
    ...
    const uint32_t sig_adc_sdivmod_first[] = {
        0xE2102480, 0x42600000, 0xE0323041, 0x22611000, 0xE070C1A1, 0x3A000020,
        0xE070C421, 0x3A00000F, 0xE1A00400, 0xE38224FF, 0xE070C221, 0x3A000017,
        0xE070C421, 0x3A000009, 0xE1A00400, 0xE38228FF, 0xE070C421, 0x21A00400,
        0x23822CFF, 0xE070C221, 0x3A00000E, 0xE270C000};

    const uint32_t sig_adc_sdivmod_second[] = {
        0x21A00420, 0xE070C3A1, 0x20411380, 0xE0A22002, 0xE070C321, 0x20411300,
        0xE0A22002, 0xE070C2A1, 0x20411280, 0xE0A22002, 0xE070C221, 0x20411200,
        0xE0A22002, 0xE070C1A1, 0x20411180, 0xE0A22002, 0xE070C121, 0x20411100,
        0xE0A22002, 0xE070C0A1, 0x20411080, 0xE0A22002, 0xE070C001, 0x20411000,
        0xE0B22002, 0x2AFFFFE5, 0xE0320FC3, 0xE0800FA3, 0x22611000, 0xE12FFF1E};

    const uint32_t sig_adc_udiv10[] = {0xE240100A, 0xE0400120, 0xE0800220, 0xE0800420,
                                       0xE0800820, 0xE1A001A0, 0xE0802100, 0xE0511082,
                                       0x52800001, 0x4281100A, 0xE12FFF1E};

    const uint32_t sig_adc_sdiv10[] = {0xE1B03000, 0x42600000, 0xE240100A, 0xE0400120,
                                       0xE0800220, 0xE0800420, 0xE0800820, 0xE1A001A0,
                                       0xE0802100, 0xE0511082, 0x52800001, 0x4281100A,
                                       0xE1B03003, 0x42600000, 0x42611000, 0xE12FFF1E};

    const uint32_t sig_adc_memcpy[] = {
    ...
    void optimizeAt_ADC_udivmod(uint32_t* code, size_t size) {
    ...
    void optimizeAt_ADC_sdivmod(uint32_t* code, size_t size) {
    ...
    void optimizeAt_ADC_udiv10(uint32_t* code, size_t size) {
    ...
    void optimizeAt_ADC_sdiv10(uint32_t* code, size_t size) {
    ...
    void optimizeAt_ADC_memcpy(uint32_t* code, size_t size) {
