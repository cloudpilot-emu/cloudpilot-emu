...
namespace {
    constexpr uint8 sdCardCrc7Table[256] = {
    ...
    constexpr uint16 sdCardCrc16Table[256] = {
...
uint8 crc::sdCRC7(const uint8* data, size_t size) {
    uint8 crc = 0x00;
...
uint16 crc::sdCRC16(const uint8* data, size_t size) {
    uint16_t crc = 0x0000;
