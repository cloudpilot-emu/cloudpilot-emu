...
namespace {
    ...
    CallROMType HeadpatchNetLibSocketConnect(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.SocketConnect(socket, sockAddrP, addrLen, timeout);
    ...
    CallROMType HeadpatchNetLibSocketListen(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.SocketListen(socket, timeout);
    ...
    CallROMType HeadpatchNetLibSocketAccept(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.SocketAccept(socket, timeout);
    ...
    CallROMType HeadpatchNetLibSocketShutdown(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.SocketShutdown(socket, direction, timeout);
    ...
    CallROMType HeadpatchNetLibReceivePB(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.SocketReceivePB(socket, pbP, flags, timeout);
    ...
    CallROMType HeadpatchNetLibGetHostByName(void) {
        ...
        if (Feature::GetNetworkRedirection()) {
            gNetworkProxy.GetHostByName(string(nameP));
