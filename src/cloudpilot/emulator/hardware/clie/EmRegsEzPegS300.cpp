...
EmRegsEzPegS300::EmRegsEzPegS300(EmRegsMB86189& mb86169)
    : EZ(mb86169), fSPISlaveADC(new EmSPISlaveADS784x(kChannelSet2)) {}
...
Bool EmRegsEzPegS300::IDDetectAsserted(void) { return false; }
