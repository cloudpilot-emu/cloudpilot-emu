...
void die(const char *msg, ...) __attribute((format(printf, 1, 2)));

/* Displays a prinf-style message and terminates the program. */

void pdie(const char *msg, ...) __attribute((format(printf, 1, 2)));
...
int xasprintf(char **strp, const char *fmt, ...) __attribute((format(printf, 2, 3)));
